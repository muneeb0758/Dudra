  ...
  return (
    <Box maxW="1400px" mx="auto" p={[4, 6, 8]}>
      ...
      <Box my={12}>
        <Heading size="lg" mb={6}>Frequently Bought Together</Heading>
        <Flex wrap="wrap" gap={6}>
          {/* Placeholder: Fetch related products from Firestore if needed */}
          {Array(4).fill().map((_, i) => (
            <Box key={i} w="250px" borderWidth="1px" borderRadius="md" p={4}>
              <Image src="https://via.placeholder.com/150" h="150px" w="100%" objectFit="contain" mb={4} />
              <Text fontWeight="500" noOfLines={2} mb={2}>Placeholder Product</Text>
              <Text color="blue.600" fontWeight="bold" mb={4}>£10.00</Text>
              <Button size="sm" w="100%">Add to Cart</Button>
            </Box>
          ))}
        </Flex>
      ...
      <Box my={12}>
        ...
        <Accordion allowToggle>
          <AccordionItem>
            <AccordionButton>
              <Box flex="1" textAlign="left">Is this product gluten-free?</Box>
              <AccordionIcon />
            </AccordionButton>
            <AccordionPanel pb={4}>
              Yes, this product is certified gluten-free and suitable for celiac diets.
